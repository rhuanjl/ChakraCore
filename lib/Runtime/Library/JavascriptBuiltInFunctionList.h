...
BUILTIN(JavascriptGenerator, AsyncNext, EntryAsyncNext, FunctionInfo::ErrorOnNew)
BUILTIN(JavascriptGenerator, AsyncReturn, EntryAsyncReturn, FunctionInfo::ErrorOnNew)
BUILTIN(JavascriptGenerator, AsyncThrow, EntryAsyncThrow, FunctionInfo::ErrorOnNew)
