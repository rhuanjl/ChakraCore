...
ENTRY_SERIALIZE_ENUM(frame_slotArray)
ENTRY_SERIALIZE_ENUM(arguments_values)
ENTRY_SERIALIZE_ENUM(target)
ENTRY_SERIALIZE_ENUM(reject)
ENTRY_SERIALIZE_ENUM(resolve)
ENTRY_SERIALIZE_ENUM(otherMethod)
